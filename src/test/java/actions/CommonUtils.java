...
public class CommonUtils extends Actions {
	...
	/**
	 * This method return the count of matching instances from the given list of WebElement
	 * 
	...
	/**
	 * To verify if the given string is present in a list of given tags
	 * 
	 * @param listNewsDescriptionsInH3Tag
	 * @param listNewsDescriptionsInSpanTag
	 * @param listNewsDescriptionsInDivTag
	 * @param strExpectedValue
	 * @throws CustomisedException
	 */
	public static void verifyIfTheStringIsPresentInAList(List<WebElement> listNewsDescriptionsInH3Tag,
			List<WebElement> listNewsDescriptionsInSpanTag, List<WebElement> listNewsDescriptionsInDivTag,
			String strExpectedValue) throws CustomisedException {
		int count = 0;
		...
		logger.debug("Number of matching instances from 'verifyIfTheStringIsPresentInAList': "+count);
		if (count < 2) {
			throw new CustomisedException("Expected: 2 or more matching sources for the article. Actual: " + count
